...
export async function POST(req: Request) {
  ...
  const payload = {
    ...
    loading_time_from: loading_time_from ?? null,
    loading_time_to: loading_time_to ?? null,
    loading_text: loading_text ?? null,
    unloading_date: unloading_date ?? null,
    unloading_time_from: unloading_time_from ?? null,
    unloading_time_to: unloading_time_to ?? null,
